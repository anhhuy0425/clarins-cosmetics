                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="page-header-st3-content text-center text-md-start">
                                ...
                                <h2 class="page-header-title">Category: {{$category->name}}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3 g-sm-6">
                        <div class="col-6 col-lg-4 col-lg-2 col-xl-2">
                            <a href="product.html" class="product-category-item">
                                <img class="icon" src="{{asset('assets/images/shop/category/face.webp')}}" width="70" height="80" alt="Image-HasTech">
                        ...
                        <div class="col-6 col-lg-4 col-lg-2 col-xl-2">
                            <a href="product.html" class="product-category-item" data-bg-color="#FFEDB4">
                                <img class="icon" src="{{asset('assets/images/shop/category/body.png')}}" width="80" height="80" alt="Image-HasTech">
                        ...
                        <div class="col-6 col-lg-4 col-lg-2 col-xl-2 mt-lg-0 mt-sm-6 mt-4">
                            <a href="product.html" class="product-category-item" data-bg-color="#DFE4FF">
                                <img class="icon" src="{{asset('assets/images/shop/category/Sunscreen.webp')}}" width="80" height="80" alt="Image-HasTech">
                                <h3 class="title">Sunscreen</h3>
                            </a>
                        </div>
                        <div class="col-6 col-lg-4 col-lg-2 col-xl-2 mt-lg-0 mt-sm-6 mt-4">
                            <a href="product.html" class="product-category-item" data-bg-color="#DFE4FF">
                                <img class="icon" src="{{asset('assets/images/shop/category/hair.png')}}" width="80" height="80" alt="Image-HasTech">
                        ...
                        <div class="col-6 col-lg-4 col-lg-2 col-xl-2 mt-xl-0 mt-sm-6 mt-4">
                            <a href="product.html" class="product-category-item" data-bg-color="#FFDAE0">
                                <img class="icon" src="{{asset('assets/images/shop/category/MakeUp.webp')}}" width="80" height="80" alt="Image-HasTech">
